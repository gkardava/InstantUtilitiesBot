...
### Usage:
Default command is `/ddg`, so without any specified commands it will try to use duckduck instant. `/help` - Shows all the commands with examples for some of them
